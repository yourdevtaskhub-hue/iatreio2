            ...
            >
              <blockquote className="text-gray-700 italic text-base leading-relaxed font-nunito mb-6">
                "{language === 'gr' 
                  ...
                  : 'D.W. Winnicott said "It is a joy to be hidden, and disaster not to be found" and within this phrase lies the entire meaning of child psychiatry. The unconscious often hides our traumas, uses our defenses and tests our own endurance as well as that of our environment. As a child psychiatrist I have the role of the specialist who notes the obvious and as a psychotherapist I simultaneously investigate the well-hidden that causes the difficulty. Then with love for the child and the institution of the family we work together to overcome any difficulty that has become an obstacle to their development.'
                }"
              </blockquote>
