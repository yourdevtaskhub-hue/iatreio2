  ...
  const teamMembers = [
    {
      ...
      image: '/src/assets/profile.png', // Θα χρησιμοποιήσω μια από τις υπάρχουσες φωτογραφίες
...
Η κλινική παιδοψυχολόγος μιλάει άψογα ελληνικά και γερμανικά.`
    },
    {
      id: 2,
      name: 'Πισσάρη Ιωάννα',
      image: '/src/assets/profile2.png', // Θα χρησιμοποιήσω μια από τις υπάρχουσες φωτογραφίες
