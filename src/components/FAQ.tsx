      ...
      faqs: [
        {
          ...
          answer: 'Αναζητήστε βοήθεια όταν παρατηρείτε σημαντικές αλλαγές στη συμπεριφορά, τη διάθεση ή την απόδοση του παιδιού σας που διαρκούν. Αυτό μπορεί να περιλαμβάνει απομονωση του παιδιου, έντονο άγχος, θλίψη , αλλαγές στον ύπνο ή την όρεξη, ή δυσκολίες στο σχολείο.'
        },
        {
          question: 'Πώς λειτουργούν οι διαδικτυακές συνεδρίες;',
          answer: 'Οι διαδικτυακές συνεδρίες γίνονται μέσω ασφαλούς πλατφόρμας βιντεοκλήσης. Το παιδί σας μπορεί να συμμετέχει από την άνεση του σπιτιού του, ή απο αλλο ασφαλες και ήσυχο μερος , κάτι που συχνά το βοηθά να αισθάνεται πιο άνετα. Παρέχουμε όλες τις απαραίτητες οδηγίες για τη σύνδεση και τη χρήση της πλατφόρμας.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Η πρώτη συνάντηση γινεται συνηθως με την γιατρο και τους γονεις. όπου συζητανε τις ανησυχίες και τους στόχους που εχουν για το παιδι τους . Στο ασφαλες περιβάλλον της συνεδριας, εξηγουμε τις προυποθεσεις για την θεραπεια του παιδιου και κανονίζουμε το επομενο ραντεβού να είναι με το παιδι που θα ακούσουμε και τις δικες του ανησυχιες και τους δικους του στοχους'
        },
        {
        ...
        },
        {
          ...
          answer: 'Ναι, όλες οι συνεδρίες είναι αυστηρά εμπιστευτικές. Ωστόσο, για παιδιά και εφήβους, υπάρχουν ορισμένες εξαιρέσεις όταν υπάρχει κίνδυνος αυτό ή ετεροτραυματισμού. Θα συζητήσουμε αυτά τα όρια εμπιστευτικότητας με εσάς και το παιδί σας από την αρχή.'
        }
      ]
    },
    en: {
