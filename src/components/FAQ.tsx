    ...
    gr: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: 'Η πρώτη συνάντηση γίνεται συνήθως με ειδικό και τους γονείς, όπου συζητάνε τις ανησυχίες και τους στόχους που έχουν για το παιδί τους. Στο ασφαλές περιβάλλον της συνεδρίας, εξηγούμε τις προϋποθέσεις για την θεραπεία του παιδιού και κανονίζουμε το επόμενο ραντεβού να είναι με το παιδί που θα ακούσουμε και τις δικές του ανησυχίες και τους δικούς του στόχους.'
        },
        {
          question: 'Πώς εμπλέκονται οι γονείς στη θεραπεία;',
          answer: 'Οι γονείς είναι βασικοί συνεργάτες στη θεραπευτική διαδικασία. Παρέχουμε τακτικές ενημερώσεις, καθοδήγηση για το σπίτι και στρατηγικές που μπορείτε να εφαρμόσετε για να υποστηρίξετε το παιδί σας. Προσφέρουμε επίσης συνεδρίες συμβουλετικής γονέων και συνεδρίες οικογενειακής θεραπείας όταν είναι απαραίτητο.'
        },
        {
          ...
          <div className="bg-white p-8 rounded-4xl shadow-xl border border-gray-100 max-w-2xl mx-auto">
            ...
            <div className="flex justify-center">
              <motion.button
                ...
                className="bg-gradient-to-r from-pink-200 via-purple-200 to-blue-200 text-gray-700 px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 font-poppins"
              >
