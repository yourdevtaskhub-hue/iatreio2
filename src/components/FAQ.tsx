      ...
      faqs: [
        {
          ...
          answer: 'Αναζητήστε βοήθεια όταν παρατηρείτε σημαντικές αλλαγές στη συμπεριφορά, τη διάθεση ή την απόδοση του παιδιού σας που διαρκούν περισσότερο από 2-3 εβδομάδες. Αυτό μπορεί να περιλαμβάνει αποτραβηγμένη συμπεριφορά, έντονο άγχος, αλλαγές στον ύπνο ή την όρεξη, ή δυσκολίες στο σχολείο.'
        },
        {
          question: 'Πώς λειτουργούν οι διαδικτυακές συνεδρίες;',
          answer: 'Οι διαδικτυακές συνεδρίες γίνονται μέσω ασφαλούς πλατφόρμας βιντεοκλήσης. Το παιδί σας μπορεί να συμμετέχει από την άνεση του σπιτιού του, κάτι που συχνά το βοηθά να αισθάνεται πιο άνετα. Παρέχουμε όλες τις απαραίτητες οδηγίες για τη σύνδεση και τη χρήση της πλατφόρμας.'
        },
        {
          question: 'Πόσο διαρκεί συνήθως η θεραπεία;',
          answer: 'Η διάρκεια της θεραπείας εξαρτάται από τις ατομικές ανάγκες του παιδιού σας. Ορισμένα προβλήματα μπορεί να βελτιωθούν σε λίγες εβδομάδες, ενώ άλλα μπορεί να χρειάζονται μήνες. Αξιολογούμε τακτικά την πρόοδο και προσαρμόζουμε το σχέδιο θεραπείας ανάλογα.'
        },
        {
          question: 'Τι πρέπει να περιμένω από την πρώτη συνάντηση;',
          answer: 'Η πρώτη συνάντηση είναι μια ολοκληρωμένη αξιολόγηση όπου θα συζητήσουμε την ιστορία του παιδιού σας, τις τρέχουσες ανησυχίες και τους στόχους σας. Θα δημιουργήσουμε ένα ασφαλές περιβάλλον όπου το παιδί σας θα αισθάνεται άνετα να εκφραστεί.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Ναι, όλες οι συνεδρίες είναι αυστηρά εμπιστευτικές. Ωστόσο, για παιδιά και εφήβους, υπάρχουν ορισμένες εξαιρέσεις όταν υπάρχει κίνδυνος βλάβης. Θα συζητήσουμε αυτά τα όρια εμπιστευτικότητας με εσάς και το παιδί σας από την αρχή.'
        }
      ]
    },
    en: {
